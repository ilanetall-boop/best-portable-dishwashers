 ...
 *   node tools/deploy-cf.js   (git-archive export, never .git/)
 */
'use strict';
const fs = require('fs');
...
/* Chrome colour follows index.html instead of being hardcoded per niche. */
const THEME_COLOR = (fs.readFileSync(path.join(ROOT, 'index.html'), 'utf8')
  .match(/name="theme-color" content="([^"]+)"/) || [null, '#101820'])[1];
const today = () => {
...
<meta name="description" content="Every guide, comparison and how-to on ${SITE.name} — research-based, honest, and updated for 2026.">
